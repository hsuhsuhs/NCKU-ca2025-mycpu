...
VTop::VTop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_deviceSelect{vlSymsp->TOP.io_deviceSelect}
    ...
    , io_csr_regs_debug_read_address{vlSymsp->TOP.io_csr_regs_debug_read_address}
    ...
    , io_csr_regs_debug_read_data{vlSymsp->TOP.io_csr_regs_debug_read_data}
    , rootp{&(vlSymsp->TOP)}
{
