...
class InstructionDecode extends Module {
  ...
  val immS = Cat(
    Fill(Parameters.DataBits - 12, instruction(31)), // Sign extension: replicate bit 31
    instruction(31, 25),                             // High 7 bits: imm[11:5]
    instruction(11, 7)                               // Low 5 bits: imm[4:0]
  )
  ...
  val immB = Cat(
    Fill(Parameters.DataBits - 13, instruction(31)), // Sign extension: replicate bit 31 (imm[12])
  ...
  val immJ = Cat(
    Fill(Parameters.DataBits - 21, instruction(31)), // Sign extension: replicate bit 31 (imm[20])
