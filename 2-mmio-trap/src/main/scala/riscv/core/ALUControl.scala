...
class ALUControl extends Module {
  ...
  // FIX: Define funct7_5 which is used in Mux statements
  val funct7_5 = io.funct7(5) 
    ...
    is(InstructionTypes.OpImm) {
      ...
      io.alu_funct := MuxLookup(io.funct3, ALUFunctions.zero)(
        Seq(
          ...
          InstructionsTypeI.sri   -> Mux(funct7_5, ALUFunctions.sra, ALUFunctions.srl) // Use funct7[5] for SRAI/SRLI
        )
      )
    }
    ...
    is(InstructionTypes.Op) {
      ...
      io.alu_funct := MuxLookup(io.funct3, ALUFunctions.zero)(
        Seq(
          ...
          //    funct7[5] = 1 → SUB
          // TODO: Complete Mux selection logic
          InstructionsTypeR.add_sub -> Mux(funct7_5, ALUFunctions.sub, ALUFunctions.add), // Use funct7[5] for SUB/ADD
          ...
          // TODO: Complete Mux selection logic
          InstructionsTypeR.sr      -> Mux(funct7_5, ALUFunctions.sra, ALUFunctions.srl) // Use funct7[5] for SRA/SRL
        )
      )
    }
